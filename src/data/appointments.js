...
export const appointments = [
  ...
  { id: "A2", patientId: "P26", doctorId: "DOC1", hospitalId: "H1", appointmentTime: `${todayStr}T09:45:00Z`, status: "BOOKED" },
  ...
  // Upcoming (Tomorrow)
  { id: "A9", patientId: "P28", doctorId: "DOC1", hospitalId: "H1", appointmentTime: `${tomorrowStr}T09:00:00Z`, status: "BOOKED" },
  { id: "A10", patientId: "P2", doctorId: "DOC5", hospitalId: "H2", appointmentTime: `${tomorrowStr}T11:30:00Z`, status: "BOOKED" },
  
  // Past (Yesterday)
  { id: "A11", patientId: "P29", doctorId: "DOC2", hospitalId: "H1", appointmentTime: `${yesterdayStr}T14:00:00Z`, status: "COMPLETED" },
  ...
  { id: "A18", patientId: "P28", doctorId: "DOC11", hospitalId: "H2", appointmentTime: `${todayStr}T11:00:00Z`, status: "BOOKED" },
