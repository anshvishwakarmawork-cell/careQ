...
export const RoleSelection = () => {
  ...
  return (
    <div className="min-h-screen bg-section flex flex-col items-center py-12 px-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center text-muted">
          <p className="mb-4 text-sm">Reception staff accounts are issued by your hospital.</p>
          <p>
